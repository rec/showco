...
class CliTests(unittest.TestCase):
    def test_dispatches_run_subcommand(self) -> None:
        with patch.object(cli, "git_pull_main", return_value=7) as git_pull:
    ...
    def test_dispatches_provision_subcommand(self) -> None:
        with patch.object(cli, "provision_main", return_value=7) as provision:
    ...
    def test_dispatches_twitcho_subcommand(self) -> None:
        with patch.object(cli, "twitcho_auth_main", return_value=7) as twitcho:
