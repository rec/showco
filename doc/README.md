...
- **Test X18 cables** pauses audio recording while it runs, then restores it if it was recording. It temporarily changes X18 routing and restores the affected mixer settings afterward. The default sends AUX 1-6 to inputs 9-14; those AUX buses must be routed to their matching physical outputs. Results require at least 98 percent tone similarity, 70-130 percent level, and no clipping.
